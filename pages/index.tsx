...
const Home: NextPage = () => {
  ...
  const { data: winnings } = useContractData(contract, "getWinningForAddress", address)

  const { mutateAsync: WithdrawWinnings } = useContractCall(contract, "WitdrawWinnings")
  ...
  const handleClick = async () => {
      ...
      try {
        ...
        toast.error("Whoops somthing went wrond", {
          id: notification
        } )

        console.error('contract call failur', err)
      }
  }
        ...
        <div className='stats-container'>
          ...
          <div className="stats-container space-y-2">
            <div className="stats-container">
              ...
              <div className='flex text-white items-center space-x-2 bg-[#091B18] border-[#004337] border p-5'>
                <p>TICKETS</p>
